                                    ...
                                    <div class="p-2 mt-4">
                                        <form action="{{ route('admin.login') }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="email" name="email" value="admin@gmail.com" class="form-control" id="username" placeholder="Enter email">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative auth-pass-inputgroup mb-3">
                                                    <input type="password" name="password" value="admin123" class="form-control pe-5" placeholder="Enter password" id="password-input">
